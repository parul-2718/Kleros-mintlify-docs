...
description: "Integrate Vea cross-chain messaging using sender and receiver gateways, VeaInbox, and VeaOutbox to pass data between Arbitrum, Ethereum, and Gnosis."
---
