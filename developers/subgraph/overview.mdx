...
description: "Query Kleros V2 KlerosCore and V1 Curate, PoH, Escrow, and Linguo data using The Graph subgraphs for disputes, courts, jurors, and registry items."
---
