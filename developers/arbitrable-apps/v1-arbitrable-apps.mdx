---
title: "Arbitrable Apps V1"
description: "Build a Kleros V1 arbitrable contract using ERC-792 and ERC-1497: create disputes on KlerosLiquid, submit evidence, and enforce jury rulings."
---

<Note>
  This guide covers V1 integration with KlerosLiquid on Ethereum Mainnet. For new integrations, use [Kleros V2 on Arbitrum](/developers/arbitrable-apps/arbitrable-overview).
</Note>
