...
description: "The V1 evidence standard defining how arbitrable contracts share MetaEvidence and Evidence with Kleros arbitrators via IPFS and event logs."
---
