...
description: "Reference for Kleros Curate V2 smart contracts, including item structs, request lifecycle, arbitration hooks, and function signatures for integrators."
