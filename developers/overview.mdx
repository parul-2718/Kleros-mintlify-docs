...
<CardGroup cols={2}>
  ...
  <Card title="Battle-Tested" icon="shield-check">
    Hundreds of disputes resolved across DeFi, curation, identity, and more since 2018.
  </Card>
</CardGroup>
...
2. When a dispute arises, call `createDispute()` with arbitration fees (ETH or accepted ERC-20 tokens)
