...
description: "Kleros V2 Court specification: hierarchy tree structure, minStake, feeForJuror, hidden votes, timesPerPeriod, and other on-chain court parameters."
---
