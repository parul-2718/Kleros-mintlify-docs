...
description: "KlerosGovernor reference: on-chain governance contract that executes Snapshot-approved transaction lists, with Kleros Court arbitration for disputes."
---
...
[View Source](https://github.com/kleros/governor-v2)