...
description: "DisputeTemplateRegistry contract reference: register, retrieve, and version dispute templates that define juror questions, options, and metadata."
---
