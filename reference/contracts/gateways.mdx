...
description: "Home and Foreign Gateway contract reference for cross-chain Kleros V2 arbitration between KlerosCore on Arbitrum and arbitrables on foreign chains."
hidden: true
---
