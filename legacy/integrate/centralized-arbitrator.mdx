...
description: "Legacy V1 guide to the Centralized Arbitrator dashboard: deploy a test arbitrator to debug arbitrable apps before connecting to KlerosLiquid V1 on Ethereum."
---
