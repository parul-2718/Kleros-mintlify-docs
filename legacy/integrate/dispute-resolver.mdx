...
description: "Legacy Kleros Dispute Resolver V1 guide: create, manage, and resolve custom disputes on Kleros Court V1 through a web interface, without smart contracts."
---
