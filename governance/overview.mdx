...
description: "PNK token holders govern the Kleros protocol, voting on parameter changes, contract deployments, policies, and incentives through a four-step lifecycle."
---
