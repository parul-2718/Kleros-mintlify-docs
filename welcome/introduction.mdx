---
title: "Introduction"
description: "New to Kleros? Start with a short introduction to the protocol, its crowdsourced juror system, and the products built on decentralized dispute resolution."
---
...
<CardGroup cols={3}>
  ...
  <Card title="Become a juror" icon="user-plus" href="https://kleros.notion.site/Complete-Beginner-s-Guide-to-Kleros-Court-V2-20e9a9db4f08803da1b2c372ed2f2c6e">
...
<Frame>
  <img src="/images/kleros-hero.png" alt="Kleros Court Interface" />
</Frame>
---
...
<Tabs>
  ...
  <Tab title="Build an arbitrable app">
    ...
    <CardGroup cols={2}>
      <Card title="Integration guide" icon="book" href="/developers/arbitrable-apps/arbitrable-guide">
        Complete walkthrough with code examples
      </Card>
      <Card title="Testing" icon="flask" href="/developers/arbitrable-apps/arbitrable-testing">
      ...
      <Card title="V1 Standards" icon="file-contract" href="/developers/arbitrable-apps/erc-792">
