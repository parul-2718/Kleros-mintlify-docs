...
<Step title="Appeal Funding">
  ...
  - **Loser of the current ruling**: Funds to overturn the ruling (2× appeal cost)
  - **Winner of the current ruling**: Funds to defend the ruling (1× appeal cost)
</Step>
...
| --- | --- | --- |
| **Loser of current ruling** | 2× appeal cost | Higher barrier discourages frivolous appeals |
| **Winner of current ruling** | 1× appeal cost | Lower cost to defend legitimate rulings |
...
| Party | Deadline |
| --- | --- |
| **Loser of current ruling** | First half of appeal period only |
| **Winner of current ruling** | Entire appeal period |

This asymmetry creates urgency for the losing party while giving the winning party adequate time to respond.
