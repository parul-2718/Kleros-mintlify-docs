---
title: "Quickstart"
description: "Get a Mintlify documentation site running locally in three steps: clone your docs repository, install the CLI, and make your first customization to the content."
---
