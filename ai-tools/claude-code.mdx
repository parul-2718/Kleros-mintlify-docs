...
description: "Install and configure Anthropic's Claude Code CLI to help write, edit, and maintain your Mintlify documentation directly from the command line."
icon: "asterisk"
---
