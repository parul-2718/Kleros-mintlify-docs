---
title: "Cursor setup"
description: "Configure the Cursor editor with project rules for technical writing and Mintlify components, so its AI produces better documentation edits on your repo."
icon: "arrow-pointer"
---
