...
<Warning>
Proof of Humanity uses the **Kleros V1 protocol** for dispute resolution — including "PoH 2.0". The "2.0" refers to product improvements (cross-chain support, improved UX), not the underlying Kleros arbitration protocol version.

PoH was originally deployed before Kleros V2 existed. Migrating to V2 would require a significant governance coordination effort across both the Kleros and PoH communities. Kleros V1 is **not deprecated** — it remains in active use for PoH and other applications that predate V2 or have not yet migrated.
</Warning>
