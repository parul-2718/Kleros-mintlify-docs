...
<Note>Scout currently uses **V1 Curate registries**. The Scout V2 frontend redesign is complete, but migration of the underlying registries from V1 to V2 has no confirmed timeline or approved KIP as of this writing. Check the [Kleros blog](https://blog.kleros.io) or [governance forum](https://forum.kleros.io) for the latest status.</Note>
