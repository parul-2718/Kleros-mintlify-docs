---
title: 'Development'
description: 'Install the Mintlify CLI and run your documentation site locally with Node.js 19+ and a docs.json file, so you can preview edits before publishing them.'
---
