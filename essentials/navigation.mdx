---
title: 'Navigation'
description: 'Configure the navigation menu of a Mintlify documentation site through the navigation field in docs.json, listing pages and grouping them into sections.'
icon: 'map'
---
