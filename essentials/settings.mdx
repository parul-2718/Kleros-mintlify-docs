...
description: 'Every Mintlify site is configured through docs.json. Review the core properties that control theme, colors, logo, navigation, and overall look and feel.'
icon: 'gear'
---
